        ...
        m_ui(new Ui::RedefineMnemonicsDialog)
{
    ...
    if (Pep::getSystem() != "Mac") {
        m_ui->unaryOpCodeLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        ...
        m_ui->unaryMnemonicLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        ...
        m_ui->nonunaryMnemonicLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->iLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->dLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->nLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->sLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->sfLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->xLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->sxLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
        m_ui->sxfLabel->setFont(QFont(Pep::labelFont, 13, QFont::bold()));
